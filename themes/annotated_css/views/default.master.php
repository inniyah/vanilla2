      ...
      <div id="Head">
         <div class="Menu">
            ...
            <?php
			      $Session = Gdn::Session();
					if ($this->Menu) {
$this->Menu->AddLink('Link 1', T('Link 1'), 'http://http://vanillaforums.org');
$this->Menu->AddLink('Link 2', T('Link 2'), 'http://www.whu606.com');
 ...
 <div id="LinkExchange" class="Box">
    ...
    <li><strong><a href="#" onclick="window.open('http://www.google.com', 'mywindow', 'width=800,height=600,resizable=yes');">Google in new window</a></strong>&nbsp;</li>

<li><strong><a href="http://www.bbc.co.uk" target="_new">BBC - external link</a></strong>&nbsp;</li>
<li><strong><a href="http://www.whu606.com/discussion/2872" target="_new">Link to forum thread</a></strong>&nbsp;</li>
    <li><strong><a href="http://www.whufc.com" target="_new">Official Site</a></strong>&nbsp;</li>
    <li><strong><a href="http://www.westhamstats.info/westham.php?west=0" target="_new">West Ham Statistics</a></strong>&nbsp;</li>
    </ul>
    </div>
